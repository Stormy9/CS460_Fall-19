...
namespace CS460_Hwk08.Controllers
{
    public class AthletesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AthleteID,AthleteName,Gender,CoachID,TeamID")] Athlete athlete)
        {
            ...
            ViewBag.CoachID = new SelectList(db.Coaches.OrderBy(c => c.CoachName), "CoachID", "CoachName", athlete.CoachID);
            ViewBag.TeamID = new SelectList(db.Teams.OrderBy(t => t.TeamName), "TeamID", "TeamName", athlete.TeamID);
            ViewBag.GenderList = genderSelectList;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AthleteID,AthleteName,Gender,CoachID,TeamID")] Athlete athlete)
        {
            if (ModelState.IsValid)
            {
        ...
        //
        //    ViewBag.SearchTerm = search; <= 'search' is a passed-in param to the ActionResult
        //
