// so this does NOTHING..... nothing at all..... no effect what-so-f'ing-ever.....   [=
//
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (get_users_repo_list) {
            ...
            for (var i = 0; i < repo_list_json.length; i++) {
                $('#repo_list_commits_button'+i).on('click', { 'user':repo_list_json[i].owner.login, 'repo':repo_list_json[i].name }, function (list_repos) {
                    var list_commits_uri = baseURL + "repos/"+list_repos.data.user+"/"+list_repos.data.repo+"/commits";
                    ...
                    $.ajax({
                        ...
                        //    a 409 must be something on *their* end -- not mine!
                        type: "GET",
                        dataType: "json",
                        //---------------------------------------------------------------
