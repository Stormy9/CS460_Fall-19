...
namespace CS460_Hwk06.DAL
{
    ...
    public partial class WWIContext : DbContext
    {
        ...
        //===============================================================================
        // goes to the StockItem table -- which is what we want for our search -- right??
        // and the `StockItems` here is why we have to use the plural in our Controller??
